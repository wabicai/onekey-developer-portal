...
> Note: This section centers on the native provider flow based on EIP-1193. If your app already uses Wallet Kits or needs compatibility guidance, see [Wallet Kits](wallet-kits).
...
See [Web (Injected Provider)](provider) for details.
