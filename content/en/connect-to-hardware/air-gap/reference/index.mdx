---
title: Air‑Gap SDK API Reference
---
...
- [Air‑Gap Quick Start](../quick-start)

Tip: Study `basic-api` before implementing scanning/decoding to ensure correct parsing.

Note on Tron: Tron Air‑Gap helpers live in our QR wallet SDK and follow the same UR patterns; see [Tron Quick Start](../quick-start/tron) for usage.
