...
- **Transport Setup:** [WebUSB](/en/connect-to-hardware/hardware-sdk/transport/web-usb) | [React Native BLE](/en/connect-to-hardware/hardware-sdk/transport/react-native-ble) | [Native BLE](/en/connect-to-hardware/hardware-sdk/transport/android)
- **Chain APIs:** Use the chain selector in the sidebar to find specific signing methods
- **Reference:** [Common Params](/en/connect-to-hardware/hardware-sdk/api-reference/common-params) | [Error Codes](/en/connect-to-hardware/hardware-sdk/api-reference/error-code)
