...
- Always subscribe early to `UI_EVENT` so PIN/Passphrase/confirmations do not stall requests. See [Config Event](../api-reference/config-event).
...
- [Error Code](../api-reference/error-code), [Common Params](../api-reference/common-params)
- Protocol framing (64 bytes, for reference only): [OneKey Message Protocol](native-ble/onekey-message-protocol)
