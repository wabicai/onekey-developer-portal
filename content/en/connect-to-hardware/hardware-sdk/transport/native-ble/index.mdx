...
# Native Bluetooth (low-level adapter and onekey-message-protocol)
...
- Transport uses 64-byte packets: [OneKey Message Protocol](./onekey-message-protocol)
...
- iOS: [iOS — Connect via Bluetooth](./ios)
- Android: [Android — Connect via Bluetooth](./android)
- React Native (BLE): [React Native BLE](../react-native-ble)
  - and [Config Event](../../api-reference/config-event)
