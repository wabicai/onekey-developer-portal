...
Handle `UI_EVENT` in your JS bundle and respond with `HardwareSDK.uiResponse`. See [Config Event](../../api-reference/config-event) for event wiring and the WebUSB guide for minimal, production-ready dialogs.
