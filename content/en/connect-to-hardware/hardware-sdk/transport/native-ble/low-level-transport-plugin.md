...
Refer to the [Message protocol](onekey-message-protocol).
...
- iOS BLE (Native, low-level adapter) → [iOS Guide](./ios)
- Android BLE (Native, low-level adapter) → [Android Guide](./android)
- Flutter BLE (Native, low-level adapter) → [Flutter Guide](./flutter)
