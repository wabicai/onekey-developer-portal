...
- Protocol framing: [OneKey Message Protocol](./onekey-message-protocol)
- UI events: [Config Event](../../api-reference/config-event), [PIN](../../quick-start/ui-events-pin), [Passphrase](../../quick-start/ui-events-passphrase)
