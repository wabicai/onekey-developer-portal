...
- For details, see: [Config Event](../api-reference/config-event)
...
- Events and interactions: [Config Event](../api-reference/config-event)
- API references and params: [Hardware SDK API References](../api-reference), [Common Params](../api-reference/common-params), [Error Codes](../api-reference/error-code)
