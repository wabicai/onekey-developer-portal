...
- For BTC message signing, see [BTC Sign Message](../../chains/bitcoin-and-bitcoin-forks/btcsignmessage)
- For typed data (EIP-712), see [EVM Sign Typed Data](../../chains/ethereum-and-evm/evmsigntypeddata)