...
- Full, copy‑paste dialogs for WebUSB are in [WebUSB Connection Guide](../transport/web-usb).
- Event wiring and responses: [Config Event](../api-reference/config-event).
- Deep‑dive UX and security notes: [Passphrase](../concepts/passphrase).
