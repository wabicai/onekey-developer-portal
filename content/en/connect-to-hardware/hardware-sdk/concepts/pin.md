...
- Show a single PIN prompt with two actions:
  ...
  - Enter on This Screen (Blind PIN) - fixed 3x3 keypad (1-9), mask input, never echo real digits
...
Mapping array (index 0..8 maps software label 1..9 to transformed digit):
