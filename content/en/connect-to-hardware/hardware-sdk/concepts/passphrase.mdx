...
- `passphraseState`: Obtain once via [Get Passphrase State](../basic-api/get-passphrase-state) and pass in [Common Params](../../api-reference/common-params) to reduce repeated prompts.
