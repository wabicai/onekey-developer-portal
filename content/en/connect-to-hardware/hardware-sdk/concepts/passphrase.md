...
- `passphraseState`: Obtain once via [Get Passphrase State](../api-reference/basic-api/get-passphrase-state) and pass in [Common Params](../api-reference/common-params) to reduce repeated prompts.
...
See also: [UI Events: Passphrase](../quick-start/ui-events-passphrase), [Common Params](../api-reference/common-params).
