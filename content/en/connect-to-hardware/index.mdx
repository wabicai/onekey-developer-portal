...
For Web developers getting started quickly: a compact path from init to first call, with copy‑pastable code snippets. See [Getting Started](hardware-sdk/getting-started).

## Choose Your Transport

| Platform (Stack)     | Transport  | SDK Package                                                                                           | Guide                                                     |
| -------------------- | ---------- | ------------------------------------------------------------------------------------------------------ | --------------------------------------------------------- |
| Web (Browser)        | WebUSB     | [@onekeyfe/hd-common-connect-sdk](https://github.com/OneKeyHQ/hardware-js-sdk/tree/onekey/packages/hd-common-connect-sdk) | [WebUSB Connection Guide](hardware-sdk/transport/web-usb)   |
| React Native         | BLE        | [@onekeyfe/hd-ble-sdk](https://github.com/OneKeyHQ/hardware-js-sdk/blob/onekey/packages/hd-ble-sdk)    | [React Native BLE](hardware-sdk/transport/react-native-ble) |
| Android (Native)     | BLE        | [@onekeyfe/hd-common-connect-sdk](https://github.com/OneKeyHQ/hardware-js-sdk/tree/onekey/packages/hd-common-connect-sdk) | [Android BLE](hardware-sdk/transport/native-ble/android) |
| iOS (Native)         | BLE        | [@onekeyfe/hd-common-connect-sdk](https://github.com/OneKeyHQ/hardware-js-sdk/tree/onekey/packages/hd-common-connect-sdk) | [iOS BLE](hardware-sdk/transport/native-ble/ios)  |
| Flutter              | BLE        | [@onekeyfe/hd-common-connect-sdk](https://github.com/OneKeyHQ/hardware-js-sdk/tree/onekey/packages/hd-common-connect-sdk) | [Flutter BLE](hardware-sdk/transport/native-ble/flutter) |
...
- Per‑chain APIs: [Hardware SDK API References](hardware-sdk/api-reference)
- Events and UI responses: [Config Event](hardware-sdk/api-reference/config-event)
- How to unlock the device: [PIN Code](hardware-sdk/concepts/pin)
- Need support for passphrases? [What is Passphrase](hardware-sdk/concepts/passphrase)
...
> **Air-Gap Mode:** OneKey Pro supports air-gapped signing via QR codes — no USB or Bluetooth connection required, providing the highest level of security. See [Air-Gap Integration](/en/connect-to-hardware/air-gap) for details.
...
- Message protocol (for debugging low-level transports): [OneKey Message Protocol](hardware-sdk/transport/native-ble/onekey-message-protocol)
