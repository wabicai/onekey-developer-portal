...
For Web developers getting started quickly: a compact path from init to first call, with copy‑pastable code snippets. See [Quick Start](hardware-sdk/quick-start).
