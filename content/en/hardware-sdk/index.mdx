...
For Web developers getting started quickly: a compact path from init to first call, with copy‑pastable code snippets. See [Getting Started](getting-started).
...
- How to unlock the device: [PIN Code](hardware-sdk/reference/concepts/pin)
- Need support for passphrases? [What is Passphrase](hardware-sdk/reference/concepts/passphrase)
...
- Message protocol (for debugging low-level transports): [Low-level transport plugin](/en/hardware-sdk/reference/concepts/low-level-plugin#message-protocol)
