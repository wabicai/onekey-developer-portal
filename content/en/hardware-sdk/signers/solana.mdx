...
Solana hardware signing guide (OneKey). Covers address confirmation and message/transaction signing with fixed hardened path and serialized `rawTx`. Aligned with hardware-js-sdk (Promise responses + UI events).
