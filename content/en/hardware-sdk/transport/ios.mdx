...
> This guide builds on the [Low-Level Transport Plugin](./low-level-plugin) and its 64-byte message protocol—read that first.
...
- Message Protocol (64‑byte framing): [See Low-Level Transport Plugin](../low-level-plugin#message-protocol-part-of-low-level-transport)
- Low‑level transport plugin contract: [Low-level Transport Plugin](../low-level-plugin)
