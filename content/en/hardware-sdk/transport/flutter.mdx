...
- Protocol framing: [See Low-Level Transport Plugin](./low-level-plugin#message-protocol-part-of-low-level-transport)
- UI events: [Events](../../api-reference/config-event), [PIN](../../concepts/pin), [Passphrase](../../concepts/passphrase)
