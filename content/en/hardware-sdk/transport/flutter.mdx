...
> This guide builds on the [Low-Level Transport Plugin](../reference/concepts/low-level-plugin) and its 64-byte message protocol—read that first.
...
- Protocol framing: [See Low-Level Transport Plugin](../reference/concepts/low-level-plugin#message-protocol-part-of-low-level-transport)
- UI events: [Events](/en/hardware-sdk/core-api-guide#events-ui), [PIN](../../reference/concepts/pin), [Passphrase](../../reference/concepts/passphrase)
