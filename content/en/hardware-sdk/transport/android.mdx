...
- Message Protocol (64‑byte framing): [See Low-Level Transport Plugin](.../reference/concepts/low-level-plugin#message-protocol-part-of-low-level-transport)
- Low‑level transport plugin contract: [Low-level Transport Plugin](.../reference/concepts/low-level-plugin)
