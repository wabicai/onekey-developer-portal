...
- `passphraseState`：通过 [获取 Passphrase 状态](../api-reference/basic-api/get-passphrase-state) 获取一次，并在 [通用参数](../api-reference/common-params) 中传入，以减少重复提示。
...
另请参阅：[UI 事件：Passphrase](../quick-start/ui-events-passphrase)，[通用参数](../api-reference/common-params)。
