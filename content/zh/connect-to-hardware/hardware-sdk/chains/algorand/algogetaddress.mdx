...
返回批量 Algorand 地址，不在设备上显示：

```typescript
HardwareSDK.algoGetAddress(connectId, deviceId, {
    bundle: [
        { path: "m/44'/283'/0'/0/0", showOnOneKey: false }, // 账户 1
        { path: "m/44'/283'/1'/0/0", showOnOneKey: false }, // 账户 2
        { path: "m/44'/283'/2'/0/0", showOnOneKey: false }  // 账户 3
    ]
});
```
