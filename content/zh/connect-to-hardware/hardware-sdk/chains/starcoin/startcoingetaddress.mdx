...
* `path` — _必需_ `string | Array<number>` 最小长度为 5。[更多信息](../../../api-reference/path)
...
返回多个 Starcoin 地址而不在设备上显示：

```typescript
HardwareSDK.starcoinGetAddress(connectId, deviceId, {
    bundle: [
        { path: "m/44'/101010'/0'/0/0", showOnOneKey: false }, // 账户 1
        { path: "m/44'/101010'/1'/0/0", showOnOneKey: false }, // 账户 2
        { path: "m/44'/101010'/2'/0/0", showOnOneKey: false }  // 账户 3
    ]
});
```
