...
* `signingMode` - _required_ CardanoTxSigningMode
* `inputs` - _required_ `Array` of CardanoInput
* `outputs` - _required_ `Array` of CardanoOutput
...
* `certificates` - _optional_ `Array` of CardanoCertificate
* `withdrawals` - _optional_ `Array` of CardanoWithdrawal
* `auxiliaryData` - _optional_ CardanoAuxiliaryData
* `mint` - _optional_ CardanoMint
* `scriptDataHash` - _optional_ `String`
* `collateralInputs` - _optional_ `Array` of CardanoCollateralInput
* `requiredSigners` - _optional_ `Array` of CardanoRequiredSigner
* `collateralReturn` - _optional_ CardanoOutput
* `totalCollateral` - _optional_ `String`
* `referenceInputs` - _optional_ `Array` of CardanoReferenceInput
...
### Examples <a href="#transaction-examples" id="transaction-examples"></a>
