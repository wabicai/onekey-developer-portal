...
| -------------------- | ---------- | ------------------------------------------------------------------------------------------------------ | --------------------------------------------------------- |
| Web（浏览器）        | WebUSB     | [@onekeyfe/hd-common-connect-sdk](https://github.com/OneKeyHQ/hardware-js-sdk/tree/onekey/packages/hd-common-connect-sdk) | [WebUSB 连接指南](hardware-sdk/transport/web-usb)              |
| React Native         | 蓝牙       | [@onekeyfe/hd-ble-sdk](https://github.com/OneKeyHQ/hardware-js-sdk/blob/onekey/packages/hd-ble-sdk)    | [React Native 蓝牙](hardware-sdk/transport/react-native-ble)   |
| Android（原生）      | 蓝牙       | [@onekeyfe/hd-common-connect-sdk](https://github.com/OneKeyHQ/hardware-js-sdk/tree/onekey/packages/hd-common-connect-sdk) | [Android 蓝牙](hardware-sdk/transport/native-ble/android) |
| iOS（原生）          | 蓝牙       | [@onekeyfe/hd-common-connect-sdk](https://github.com/OneKeyHQ/hardware-js-sdk/tree/onekey/packages/hd-common-connect-sdk) | [iOS 蓝牙](hardware-sdk/transport/native-ble/ios)    |
| Flutter              | 蓝牙       | [@onekeyfe/hd-common-connect-sdk](https://github.com/OneKeyHQ/hardware-js-sdk/tree/onekey/packages/hd-common-connect-sdk) | [Flutter 蓝牙](hardware-sdk/transport/native-ble/flutter) |
...
- 事件和 UI 响应：[事件配置](hardware-sdk/api-reference/config-event)
- 如何解锁设备：[PIN 码](hardware-sdk/concepts/pin)
- 需要密码短语支持？[什么是 Passphrase](hardware-sdk/concepts/passphrase)
...
- 消息协议（用于调试底层传输）：[OneKey 消息协议](hardware-sdk/transport/native-ble/onekey-message-protocol)
