...
> 本页基于《[底层传输插件](../reference/concepts/low-level-plugin)》与消息协议，建议先阅读接口与 64 字节帧格式。
...
- 协议帧：[见底层传输插件](../reference/concepts/low-level-plugin#消息协议包含在底层传输中)
- UI 事件：[事件配置](../../api-reference#events-ui)，[PIN](../../reference/concepts/pin)，[Passphrase](../../reference/concepts/passphrase)
