...
* `path` - _必需_ `string | Array<number>` **长度为 `4`，这是一个特殊的链。** [更多信息](../../../api-reference#hd-path)
...
HardwareSDK.solGetAddress(connectId, deviceId, {
    bundle: [
        { path: "m/44'/501'/0'/0'", showOnOneKey: false }, // 账户 1
        { path: "m/44'/501'/1'/0'", showOnOneKey: false }, // 账户 2
        { path: "m/44'/501'/2'/0'", showOnOneKey: false }  // 账户 3
    ]
});
```
