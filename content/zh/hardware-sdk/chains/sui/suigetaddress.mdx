...
HardwareSDK.suiGetAddress(connectId, deviceId, {
    bundle: [
        { path: "m/44'/784'/0'/0'/0", showOnOneKey: false }, // 账户 1
        { path: "m/44'/784'/1'/0'/0", showOnOneKey: false }, // 账户 2
        { path: "m/44'/784'/2'/0'/0", showOnOneKey: false }  // 账户 3
    ]
});
```
