...
<Callout type="warning" title="多链支持对比 (2025年最新)">
  MetaMask 正在快速扩展多链支持：
  - **Solana**: 2025年5月原生支持 (Wallet Standard)
  - **Bitcoin**: 2025年Q3计划原生支持
  - **Starknet**: 通过 Snap 支持
  - 其他非EVM链通过 Snaps 生态扩展
</Callout>

<FeatureTable
  headers={['链', 'MetaMask', 'OneKey', '说明']}
  rows={[
    ['EVM 链', true, true, '两者都原生支持'],
    ['Solana', true, true, 'MetaMask 使用 Wallet Standard，OneKey 使用专属 Provider'],
    ['Bitcoin', '2025 Q3', true, 'OneKey 已支持，MetaMask 计划中'],
    ['Starknet', 'Snap', false, 'MetaMask 通过 Snap 支持'],
    ['Cosmos', 'Snap', true, 'OneKey 原生 Provider'],
    ['Aptos', 'Snap', true, 'OneKey 原生 Provider'],
    ['Sui', 'Snap', true, 'OneKey 原生 Provider'],
    ['NEAR', false, true, 'OneKey 原生 Provider'],
    ['Polkadot', 'Snap', true, 'OneKey 原生 Provider'],
  ]}
/>

<Callout type="info" title="关键差异">
  1. **OneKey** 没有像 `@metamask/sdk` 那样的官方跨平台 SDK，移动端推荐使用 WalletConnect
  2. **MetaMask** 使用 Snaps 生态扩展非EVM链，OneKey 使用内置 Provider
  3. **接口兼容性**: Solana 两者都兼容 Wallet Standard，便于 dApp 适配
</Callout>
